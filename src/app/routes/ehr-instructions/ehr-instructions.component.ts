...
export class EHRLoginComponent {
    ...
    public vaSignIn() {
        ...
        var auth: string = `https://sandbox-api.va.gov/oauth2/authorization/?client_id=${this.vaService.clientId}&redirect_uri=https://smart-covid-navigator.github.io/Covid-Application/app&response_type=code&scope=${scope}&state=test1`;
        location.href = auth;
    }
